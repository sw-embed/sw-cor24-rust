//! sw-cor24-rust library
//!
//! Rust-to-COR24 translation pipeline.
//! - MSP430 path (preferred): `msp430::translate_msp430`
//! - WASM path (deprecated): `translate_wasm`

pub mod msp430;
mod pipeline;

pub use msp430::translate_msp430;
pub use pipeline::{print_leds, run_pipeline};
